...
function RecycleItem() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-black p-6 pt-20 pb-28">
      <div className="flex justify-center mb-6">
        <div className="relative w-80">
          <input
            type="text"
            className="border-2 border-gray-300 text-gray-700 rounded-2xl p-3 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition-all dark:bg-slate-100"
