    ...
    <div className="pt-20 dark:bg-black px-9 md:px-20 pb-16 md:pb-24">
      ...
      <div className="grid place-content-center gap-4 my-6">
        ...
        <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
          ...
          desire to create a platform that could make a real difference. We saw
          the urgent need for more accessible and actionable information on
          sustainability, recycling, and reducing carbon footprints. With the
          rapid pace of climate change and environmental degradation, we felt
          compelled to take action and provide a solution that empowers
        ...
        <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
          ...
          eco-friendly choices. We wanted to build a community that supports and
          inspires each other to adopt sustainable practices, reduce waste, and
          protect our planet for future generations. EcoVatika is the
          realization of that vision, a hub where sustainability meets
      ...
      <div className="">
        ...
        <div className="grid place-content-center">
          <div className="grid place-content-center gap-4 my-6">
            ...
            <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
              ...
              allows you to estimate your carbon equivalents. By inputting data
              such as O3, NO2, particulate matter, solar energy consumption,
              fuel consumption (L), and car travel (km), you can determine your
              environmental impact. EcoScore also provides information on the
              number of trees needed to offset your carbon emissions, helping
              you understand and mitigate your carbon footprint.
            </p>
          </div>
          <div className="grid place-content-center">
        ...
        <div className="grid place-content-center gap-4 my-6">
          ...
          <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
            ...
            options, and upcycling and reuse ideas. It’s your ultimate guide to
            responsible disposal and recycling, helping you make informed
        ...
        <div className="grid place-content-center gap-4 my-6">
          ...
          <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
            Test your knowledge on sustainability with our engaging Sustainable
            Quiz. Answer 10 questions to see how much you know about
            eco-friendly practices and discover new ways to live a more
            sustainable life. Your results will provide insights and tips to
            further your understanding and commitment to sustainability, making
            learning about the environment both fun and informative.
          </p>
        </div>
        ...
        <div className="grid place-content-center gap-4 my-6">
          ...
          <p className="text-gray-500 text-center md:text-left dark:text-gray-400  text-base md:text-2xl">
            ...
            browse through listings to find items that can have a second life in
            your home. Transactions are facilitated seamlessly, with buyers
      ...
      <div className="md:flex my-10 mt-16">
        <div className="grid place-content-center gap-4 my-6 md:w-[60vw]">
          ...
          <p className="text-gray-500 text-center md:text-left dark:text-gray-400 text-base md:text-2xl">
            At EcoVatika, we believe that small actions can lead to significant
            changes. By making informed choices and contributing to a healthier
            planet, we can create a sustainable future together. Explore our
            features, learn, share, and take action with EcoVatika. Join us on
            our journey towards a more sustainable world, and together, we can
            make a difference.
          </p>
        </div>
        <div className="grid place-content-center">
      ...
      <div className="grid  gap-4 py-6 ">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center md:text-left  text-base md:text-2xl">
          Thank you for visiting EcoVatika. We look forward to supporting you in
